<template>
  <div class="contain" :class="useSidebar().value ? 'shrink' : ''">
    ...
    <div class="row">
      <div class="col-lg-4" v-for="field in Contact" :key="field.name">
        <p class="d-flex align-items-start">
          <strong
            >{{ $i18n.locale === "ar" ? "الهاتف" : "Phone Number" }}:</strong
          >
          <span class="mx-2">
            {{ field.phone ?? $t("Not Provided") }}
          </span>
        </p>
      </div>
      <div class="col-lg-4" v-for="field in Contact" :key="field.name">
      ...
      <div class="col-lg-4" v-for="field in Contact" :key="field.name">
        <p class="d-flex align-items-start">
          <strong>{{ $i18n.locale === "ar" ? "الموقع" : "Website" }}:</strong>
          <span class="mx-2">
            {{ field.website ?? $t("Not Provided") }}
          </span>
        </p>
      </div>
    </div>
