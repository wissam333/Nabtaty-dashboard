...
let Subcats = ref([
  {
    fullName: "sub category 1",
  },
  { fullName: "sub category 2" },
  { fullName: "sub category 3" },
]);
...
let products = ref([
  {
    ...
    recommended: 1,
    subcategory_id: 5,
    photos: "uploads/plants/1730198706084.png",
  },
  {
    id: 2,
    plant_name: "koki1",
    ...
    recommended: 1,
    subcategory_id: 5,
    photos: "uploads/plants/1730198723577.png",
  },
]);
...
watchEffect(() => {
  if (process.client) {
    if (products.value) {
      descAr.value = products.value[Number(route.params.id) - 1].description;
      descEn.value = products.value[Number(route.params.id) - 1].description;
      titleAr.value = products.value[Number(route.params.id) - 1].plant_name;
      titleEn.value = products.value[Number(route.params.id) - 1].plant_name;

      price.value = products.value[Number(route.params.id) - 1].price;
      waterAr.value = products.value[Number(route.params.id) - 1].water;
      waterEn.value = products.value[Number(route.params.id) - 1].water;
      lightAr.value = products.value[Number(route.params.id) - 1].light;
      lightEn.value = products.value[Number(route.params.id) - 1].light;
      temperaturesAr.value = products.value[Number(route.params.id) - 1].temperatures;
      temperaturesEn.value = products.value[Number(route.params.id) - 1].temperatures;
      mediumAr.value = products.value[Number(route.params.id) - 1].medium;
      mediumEn.value = products.value[Number(route.params.id) - 1].medium;
      partAr.value = products.value[Number(route.params.id) - 1].part_sun;
      partEn.value = products.value[Number(route.params.id) - 1].part_sun;

      newest.value = products.value[Number(route.params.id) - 1].newest;
      recommended.value = products.value[Number(route.params.id) - 1].recommended;
    }
  }
});
</script>
