...
watchEffect(() => {
  if (process.client) {
    if (products.value) {
      descAr.value = products[Number(route.params.id) - 1].description;
      descEn.value = products[Number(route.params.id) - 1].description;
      titleAr.value = products[Number(route.params.id) - 1].plant_name;
      titleEn.value = products[Number(route.params.id) - 1].plant_name;

      price.value = products[Number(route.params.id) - 1].price;
      waterAr.value = products[Number(route.params.id) - 1].water;
      waterEn.value = products[Number(route.params.id) - 1].water;
      lightAr.value = products[Number(route.params.id) - 1].light;
      lightEn.value = products[Number(route.params.id) - 1].light;
      temperaturesAr.value = products[Number(route.params.id) - 1].temperatures;
      temperaturesEn.value = products[Number(route.params.id) - 1].temperatures;
      mediumAr.value = products[Number(route.params.id) - 1].medium;
      mediumEn.value = products[Number(route.params.id) - 1].medium;
      partAr.value = products[Number(route.params.id) - 1].part_sun;
      partEn.value = products[Number(route.params.id) - 1].part_sun;

      newest.value = products[Number(route.params.id) - 1].newest;
      recommended.value = products[Number(route.params.id) - 1].recommended;
    }
  }
});
</script>
