  ...
  >
    <div class="title-container">
      ...
      <div class="mt-2">
        <input
          type="submit"
          :value="{{ $i18n.locale === 'ar' ? 'تعديل' : 'Edit' }}"
...
watchEffect(() => {
  if (process.client) {
    if (products.value) {
      ...
      temperaturesAr.value =
        products.value[Number(route.params.id) - 1].temperatures;
      ...
      newest.value = products.value[Number(route.params.id) - 1].newest
        ? true
        : false;
      recommended.value = products.value[Number(route.params.id) - 1]
        .recommended
        ? true
        : false;
    }
