...
watchEffect(() => {
  if (process.client) {
    if (MainImg.value) {
      src.value = apiBase + "/" + MainImg.value[0].photo;
      src1.value = apiBase + "/" + MainImg.value[1].photo;
      src2.value = apiBase + "/" + MainImg.value[2].photo;
      src3.value = apiBase + "/" + MainImg.value[3].photo;
    }
  }
});
