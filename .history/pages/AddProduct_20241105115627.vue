        ...
        <div class="col-sm-12 col-lg-4">
          ...
          >
            <div>
              ...
              <div class="drop-area my-4" @drop="handleDrop1" @dragover.prevent>
            ...
            <div
              class="drop-area my-4"
              @drop.prevent="handleDrop(3)"
              @dragover.prevent
            >
              <div class="upload-box" v-if="!previewImage3">
                <label for="upload-icon-3" class="upload-icon">
                  <font-awesome :icon="['fas', 'upload']" />
                </label>
                <input
                  autocomplete="off"
                  ...
                  accept="image/*"
                  style="display: none"
                  @change="uploadImage($event, 'previewImage3')"
                />
              </div>
              <div v-else>
                <i
                  @click="previewImage3 = null"
                  class="bi bi-x-circle-fill close-img"
                ></i>
              </div>
              <img v-if="!previewImage3" :src="img3" alt="" />
              <img v-else :src="previewImage3" alt="" />
            </div>
...
const previewImage4 = ref(null);
const previewImage5 = ref(null);

const img2 = "default-img2.jpg"; // Replace with actual default image URLs if needed
const img3 = "default-img3.jpg";
const img4 = "default-img4.jpg";
const img5 = "default-img5.jpg";

function handleDrop(index) {
  // Implement custom drop handling logic if needed
}

function uploadImage(event, previewImageRef) {
  const file = event.target.files[0];
  if (file) {
    const reader = new FileReader();
    reader.onload = (e) => {
      switch (previewImageRef) {
        case "previewImage2":
          previewImage2.value = e.target.result;
          break;
        case "previewImage3":
          previewImage3.value = e.target.result;
          break;
        case "previewImage4":
          previewImage4.value = e.target.result;
          break;
        case "previewImage5":
          previewImage5.value = e.target.result;
          break;
      }
    };
