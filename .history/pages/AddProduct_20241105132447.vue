        ...
        <div class="col-sm-12 col-lg-4">
          ...
          >
            ...
            <div
              ...
              @dragover.prevent
            >
              <div class="upload-box" v-if="!previewImage1">
              ...
              />
              <img v-else :src="img1" alt="Default image" />
            </div>
            ...
            <div
              ...
              @dragover.prevent
            >
              <div class="upload-box" v-if="!previewImage2">
                <label for="photo-upload" class="upload-icon">
                  <font-awesome :icon="['fas', 'upload']" />
                </label>
                <input
...
const img1 = ref(""); // Replace with your default image path
...
function uploadImage1(event) {
  ...
  if (file) {
    ...
    reader.onload = () => {
      previewImage1.value = reader.result;
    };
