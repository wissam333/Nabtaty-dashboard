<template>
  ...
  <Dialog
    ...
    :style="{ width: '25rem' }"
  >
    <template #header style="flex-direction: row-reverse;">
      <h5>
    ...
    <template #footer>
      <button class="btn btn-secondary" @click="visible = false" autofocus>
        {{ $t("Cancel") }}
      </button>
      <button class="btn btn-success" @click="visible = false">
        {{ $t("Save") }}
      </button>
    </template>
  </Dialog>
