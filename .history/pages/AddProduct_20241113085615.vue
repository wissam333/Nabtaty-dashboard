...
const addProduct = async () => {
  ...
  // formData.append("quantity", uploadedFile.value);
  ...
  formData.append("newest", newest.value);
  formData.append("recommended", recommended.value);
  formData.append("subcategory_id", selectedSubCat.value);
  if (src.value) {
    formData.append("photoPath", src.value);
  }
  if (src1.value) {
    formData.append("photoPath", src1.value);
  }
  if (src2.value) {
    formData.append("photoPath", src2.value);
  }
  if (src3.value) {
    formData.append("photoPath", src3.value);
  }
  if (src4.value) {
    formData.append("photoPath", src4.value);
  }
