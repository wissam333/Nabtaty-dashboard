            ...
            <tbody>
              ...
              >
                <td class="d-flex align-items-center">
                  ...
                  <div
                    class="product-info d-flex flex-column align-items-start"
                  >
                    <h5>{{ product.title }}</h5>
                    <p>{{ product.desc }}</p>
                  </div>
...
let products = ref([
  ...
  { id: 3, name: "4K Action Camera", price: 119.99, category: "Photography" },
  { id: 4, name: "Organic Cotton T-Shirt", price: 19.99, category: "Apparel" },
  {
    id: 5,
    name: "Gaming Mouse",
    price: 34.99,
  ...
  { id: 9, name: "Yoga Mat", price: 24.99, category: "Sports & Outdoors" },
  {
    id: 10,
