<template>
  ...
  <div class="sidebar box" :class="sidebar ? '' : 'open'">
    <ul class="main-links">
      <router-link to="/HomeView/Dashboard" v-if="isAdmin">
        <li
      ...
      <ul class="second-links" :class="productDropDown ? 'showLink' : ''">
        <router-link to="/HomeView/AddProduct" v-if="isAdmin">
        ...
        <router-link to="/HomeView/ListProduct" v-if="isAdmin">
      ...
      <router-link to="/HomeView/Customers" v-if="isAdmin">
        <li
      ...
      <router-link to="/HomeView/Transfer" v-if="isAdmin">
        <li
      ...
      <router-link to="/HomeView/Orders" v-if="isAdmin">
        <li
...
let sidebar = useSidebar().value;
let activeLink = useActiveLink().value;
let subActiveLink = useSubActiveLink().value;
// variables
