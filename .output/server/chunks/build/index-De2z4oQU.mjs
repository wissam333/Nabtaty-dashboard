...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  }, _attrs))} data-v-20e89bab><div class="${ssrRenderClass([("useSidebar" in _ctx ? _ctx.useSidebar : unref(useSidebar))().value ? "shrink" : "", "mainImg"])}" data-v-20e89bab><img${ssrRenderAttr("src", _imports_0$1)} alt="" data-v-20e89bab></div></div>`);
}
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-20e89bab"]]);
const _sfc_main = {
  __name: "index",
...
//# sourceMappingURL=index-De2z4oQU.mjs.map
