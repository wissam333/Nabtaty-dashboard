import { defineComponent, computed, mergeProps, useSSRContext, ref, h, resolveComponent } from 'vue';
import { u as useRouter$1, h as hasProtocol, j as joinURL, p as parseURL, a as parseQuery, n as nuxtLinkDefaults, b as useRuntimeConfig, c as navigateTo, w as withTrailingSlash, d as withoutTrailingSlash } from './server.mjs';
  ...
  return defineComponent({
    ...
    setup(props, { slots }) {
      ...
      return () => {
        ...
        const href = typeof to.value === "object" ? (_a2 = (_a = router.resolve(to.value)) == null ? void 0 : _a.href) != null ? _a2 : null : to.value && !props.external && !isAbsoluteUrl.value ? resolveTrailingSlashBehavior(joinURL(config2.app.baseURL, to.value), router.resolve) : to.value || null;
...
//# sourceMappingURL=icon-DPyvNtFG.mjs.map
