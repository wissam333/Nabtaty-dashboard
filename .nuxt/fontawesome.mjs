import {
  ...
  faFax as freeFasFaFax,
  faBox as freeFasFaBox,
  ...
  faChartSimple as freeFasFaChartSimple,
  faList as freeFasFaList,
  faUsers as freeFasFaUsers,
  faBoxesStacked as freeFasFaBoxesStacked,
  faSeedling as freeFasFaSeedling,
