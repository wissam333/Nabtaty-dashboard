declare global {
  ...
  const errorOptions: typeof import('../../server/utils/error-options')['default']
  const eventHandler: typeof import('../../node_modules/h3')['eventHandler']
  const fetchOptions: typeof import('../../server/utils/fetch-options')['default']
...
export { default as errorOptions } from '../../server/utils/error-options';
export { default as fetchOptions } from '../../server/utils/fetch-options';