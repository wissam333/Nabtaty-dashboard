import { isVisible, getWidth, getHeight, findSingle, focus, isAndroid, getFirstFocusableElement, getLastFocusableElement, addStyle, relativePosition, getOuterWidth, absolutePosition, isTouchDevice, getFocusableElements } from "@primeuix/utils/dom";
import { isEmpty, resolveFieldData, isPrintableCharacter, isNotEmpty, equals, findLastIndex, contains } from "@primeuix/utils/object";
import { ZIndex } from "@primeuix/utils/zindex";
import { B as BaseStyle, F as FilterService } from "../server.mjs";
import { s as script$b, b as script$c, f as script$d, U as UniqueComponentId, C as ConnectedOverlayScrollHandler, R as Ripple, e as script$e, a as script$f } from "./index-CSqrJwZf.js";
import { openBlock, createElementBlock, mergeProps, createElementVNode, renderSlot, resolveComponent, Fragment, renderList, createCommentVNode, createVNode, resolveDirective, createTextVNode, toDisplayString, normalizeClass, createBlock, resolveDynamicComponent, withCtx, Transition, normalizeProps, createSlots, withDirectives } from "vue";
import { a as script$g } from "./index-Cq7zPice.js";
...
var _hoisted_1$4 = ["value", "aria-invalid"];
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, $options.getPTOptions("root")), null, 16, _hoisted_1$4);
}
        ...
        if (this.optionGroupLabel) {
          ...
          optionGroups.forEach(function(group) {
            ...
            if (filteredItems.length > 0)
              filtered.push(_objectSpread(_objectSpread({}, group), {}, _defineProperty({}, typeof _this15.optionGroupChildren === "string" ? _this15.optionGroupChildren : "items", _toConsumableArray$1(filteredItems))));
          });
...
//# sourceMappingURL=index-keOXzVG2.js.map
