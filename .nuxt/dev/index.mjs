...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://D:/Projects/Nabtaty-dashboard/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://D:/Projects/Nabtaty-dashboard/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://D:/Projects/Nabtaty-dashboard/node_modules/devalue/index.js';
import destr from 'file://D:/Projects/Nabtaty-dashboard/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file://D:/Projects/Nabtaty-dashboard/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file://D:/Projects/Nabtaty-dashboard/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file://D:/Projects/Nabtaty-dashboard/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://D:/Projects/Nabtaty-dashboard/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://D:/Projects/Nabtaty-dashboard/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://D:/Projects/Nabtaty-dashboard/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://D:/Projects/Nabtaty-dashboard/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://D:/Projects/Nabtaty-dashboard/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://D:/Projects/Nabtaty-dashboard/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file://D:/Projects/Nabtaty-dashboard/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/Projects/Nabtaty-dashboard/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/Projects/Nabtaty-dashboard/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://D:/Projects/Nabtaty-dashboard/node_modules/consola/dist/index.mjs';
import devalue from 'file://D:/Projects/Nabtaty-dashboard/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { getContext } from 'file://D:/Projects/Nabtaty-dashboard/node_modules/unctx/dist/index.mjs';
import BaseStyle from 'file://D:/Projects/Nabtaty-dashboard/node_modules/@primevue/core/base/style/index.mjs';
import { Theme } from 'file://D:/Projects/Nabtaty-dashboard/node_modules/@primeuix/styled/index.mjs';
import { version, unref } from 'file://D:/Projects/Nabtaty-dashboard/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://D:/Projects/Nabtaty-dashboard/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://D:/Projects/Nabtaty-dashboard/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"D:/Projects/Nabtaty-dashboard/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\Projects\\Nabtaty-dashboard","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\Projects\\Nabtaty-dashboard\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\Projects\\Nabtaty-dashboard\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\Projects\\Nabtaty-dashboard\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\Projects\\Nabtaty-dashboard\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _ZZRiTbBQHF = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "D:/Projects/Nabtaty-dashboard";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _08A2IWFj8o = (nitroApp) => {
...
const _kZ9VtfCWMU = defineNitroPlugin(async (nitroApp) => {
...
const _lazy_ApnbQo = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_ApnbQo, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_ApnbQo, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Nabtaty"}],"link":[{"rel":"stylesheet","href":"https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css"},{"rel":"stylesheet","href":"https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css"},{"rel":"icon","href":"/photos/tabLogo.png","type":"image/x-icon"},{"rel":"stylesheet","type":"text/css","href":"https://cdn.jsdelivr.net/npm/@mdi/font@latest/css/materialdesignicons.min.css"}],"style":[],"script":[{"src":"https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js"},{"src":"https://cdnjs.cloudflare.com/ajax/libs/animejs/2.0.2/anime.min.js"}],"noscript":[],"title":"Nabtaty","htmlAttrs":{"lang":"en"}};
...
const getClientManifest = () => import('file://D:/Projects/Nabtaty-dashboard/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://D:/Projects/Nabtaty-dashboard/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
